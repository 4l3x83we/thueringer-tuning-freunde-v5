    ...
    <div class="mx-auto max-w-screen-2xl px-4 py-8 lg:px-6 lg:py-10">
        <div class="grid grid-cols-1 gap-4">
            <div class="rounded bg-gray-50 p-4 shadow-xl group dark:bg-gray-900 flex flex-col gap-4">
                ...
                <form wire:submit.prevent="save" wire:loading.remove wire:key="{{ $form->start }}">
                ...
                <div wire:loading wire:target="save" class="flex h-64 w-full justify-center content-center">
                    <div class="h-64 grid text-center content-center">
                        <div role="status">
