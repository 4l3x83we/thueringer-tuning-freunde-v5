<div>
    ...
    <div class="mx-auto max-w-screen-2xl px-4 py-8 lg:px-6 lg:py-10">
        ...
        <div class="grid grid-cols-1 gap-4">
            ...
            <div class="my-8 rounded bg-gray-100 p-4 shadow-xl group dark:bg-gray-900 flex flex-col">

                <h1 class="text-4xl font-extrabold dark:text-white my-1">Datenschutz&shy;erkl&auml;rung</h1>
                <h2 class="text-3xl font-extrabold dark:text-white my-1">1. Datenschutz auf einen Blick</h2>
                <h3 class="text-xl font-extrabold dark:text-white my-1">Allgemeine Hinweise</h3>
                ...
                <h3 class="text-xl font-extrabold dark:text-white my-1">Datenerfassung auf dieser Website</h3>
                <h4 class="text-lg font-extrabold dark:text-white my-1">Wer ist verantwortlich f&uuml;r die Datenerfassung
                ...
                <p>Die Datenverarbeitung auf dieser Website erfolgt durch den Websitebetreiber. Dessen Kontaktdaten k&ouml;nnen
                    ...
                    entnehmen.</p> <h4 class="text-lg font-extrabold dark:text-white my-1">Wie erfassen wir Ihre Daten?</h4>
                ...
                <p>Andere Daten werden automatisch oder nach Ihrer Einwilligung beim Besuch der Website durch unsere
                    ...
                    Website betreten.</p> <h4 class="text-lg font-extrabold dark:text-white my-1">Wof&uuml;r nutzen wir Ihre
                    Daten?</h4>
                ...
                <h4 class="text-lg font-extrabold dark:text-white my-1">Welche Rechte haben Sie bez&uuml;glich Ihrer
                    Daten?</h4>
                <p>Sie haben jederzeit das Recht, unentgeltlich Auskunft &uuml;ber Herkunft, Empf&auml;nger und Zweck
                    ...
                    widerrufen. Au&szlig;erdem haben Sie das Recht, unter bestimmten Umst&auml;nden die Einschr&auml;nkung
                ...
                <p>Hierzu sowie zu weiteren Fragen zum Thema Datenschutz k&ouml;nnen Sie sich jederzeit an uns
                    wenden.</p>
                <h2 class="text-3xl font-extrabold dark:text-white my-1">2. Hosting</h2>
                <p>Wir hosten die Inhalte unserer Website bei folgendem Anbieter:</p>
                <h3 class="text-xl font-extrabold dark:text-white my-1">Externes Hosting</h3>
                ...
                <p>Das externe Hosting erfolgt zum Zwecke der Vertragserf&uuml;llung gegen&uuml;ber unseren potenziellen
                ...
                <p>myLoc managed IT AG<br/>
                    Am Gatherhof 44<br/>
                    40472 D&uuml;sseldorf</p>
                <h4 class="text-lg font-extrabold dark:text-white my-1">Auftragsverarbeitung</h4>
                ...
                <h2 class="text-3xl font-extrabold dark:text-white my-1">3. Allgemeine Hinweise und
                    Pflicht&shy;informationen</h2>
                <h3 class="text-xl font-extrabold dark:text-white my-1">Datenschutz</h3>
                ...
                <h3 class="text-xl font-extrabold dark:text-white my-1">Hinweis zur verantwortlichen Stelle</h3>
                ...
                <h3 class="text-xl font-extrabold dark:text-white my-1">Speicherdauer</h3>
                ...
                <h3 class="text-xl font-extrabold dark:text-white my-1">Allgemeine Hinweise zu den Rechtsgrundlagen der
                ...
                <h3 class="text-xl font-extrabold dark:text-white my-1">Empfänger von personenbezogenen Daten</h3>
                <p>Im Rahmen unserer Gesch&auml;ftst&auml;tigkeit arbeiten wir mit verschiedenen externen Stellen
                    ...
                    externen Stellen erforderlich. Wir geben personenbezogene Daten nur dann an externe Stellen weiter,
                    wenn dies im Rahmen einer Vertragserf&uuml;llung erforderlich ist, wenn wir gesetzlich hierzu
                    ...
                    sonstige Rechtsgrundlage die Datenweitergabe erlaubt. Beim Einsatz von Auftragsverarbeitern geben
                    wir personenbezogene Daten unserer Kunden nur auf Grundlage eines g&uuml;ltigen Vertrags &uuml;ber
                    Auftragsverarbeitung weiter. Im Falle einer gemeinsamen Verarbeitung wird ein Vertrag &uuml;ber
                    gemeinsame Verarbeitung geschlossen.</p>
                <h3 class="text-xl font-extrabold dark:text-white my-1">Widerruf Ihrer Einwilligung zur
                ...
                <h3 class="text-xl font-extrabold dark:text-white my-1">Widerspruchsrecht gegen die Datenerhebung in
                    besonderen F&auml;llen sowie gegen Direktwerbung (Art. 21 DSGVO)</h3>
                <p>WENN DIE DATENVERARBEITUNG AUF GRUNDLAGE VON ART. 6 ABS. 1 LIT. E ODER F DSGVO ERFOLGT, HABEN SIE
                    ...
                    WERDEN WIR IHRE BETROFFENEN PERSONENBEZOGENEN DATEN NICHT MEHR VERARBEITEN, ES SEI DENN, WIR K&Ouml;NNEN
                    ZWINGENDE SCHUTZW&Uuml;RDIGE GR&Uuml;NDE F&Uuml;R DIE VERARBEITUNG NACHWEISEN, DIE IHRE INTERESSEN,
                    RECHTE UND FREIHEITEN &Uuml;BERWIEGEN ODER DIE VERARBEITUNG DIENT DER GELTENDMACHUNG, AUS&Uuml;BUNG
                ...
                <p>WERDEN IHRE PERSONENBEZOGENEN DATEN VERARBEITET, UM DIREKTWERBUNG ZU BETREIBEN, SO HABEN SIE DAS
                    ...
                    DSGVO).</p>
                <h3 class="text-xl font-extrabold dark:text-white my-1">Beschwerde&shy;recht bei der zust&auml;ndigen
                ...
                <h3 class="text-xl font-extrabold dark:text-white my-1">Recht auf Daten&shy;&uuml;bertrag&shy;barkeit</h3>
                <p>Sie haben das Recht, Daten, die wir auf Grundlage Ihrer Einwilligung oder in Erf&uuml;llung eines
                    ...
                    ist.</p>
                <h3 class="text-xl font-extrabold dark:text-white my-1">Auskunft, Berichtigung und L&ouml;schung</h3>
                <p>Sie haben im Rahmen der geltenden gesetzlichen Bestimmungen jederzeit das Recht auf unentgeltliche
                    ...
                    uns wenden.</p>
                <h3 class="text-xl font-extrabold dark:text-white my-1">Recht auf Einschr&auml;nkung der Verarbeitung</h3>
                ...
                <p>Wenn Sie die Verarbeitung Ihrer personenbezogenen Daten eingeschr&auml;nkt haben, d&uuml;rfen diese
                    ...
                    einer anderen nat&uuml;rlichen oder juristischen Person oder aus Gr&uuml;nden eines wichtigen &ouml;ffentlichen
                    Interesses der Europ&auml;ischen Union oder eines Mitgliedstaats verarbeitet werden.</p>
                <h3 class="text-xl font-extrabold dark:text-white my-1">SSL- bzw. TLS-Verschl&uuml;sselung</h3>
                ...
                <h2 class="text-3xl font-extrabold dark:text-white my-1">4. Datenerfassung auf dieser Website</h2>
                <h3 class="text-xl font-extrabold dark:text-white my-1">Cookies</h3>
                <p>Unsere Internetseiten verwenden so genannte &bdquo;Cookies&ldquo;. Cookies sind kleine Datenpakete
                    und richten auf Ihrem Endger&auml;t keinen Schaden an. Sie werden entweder vor&uuml;bergehend f&uuml;r
                    die Dauer einer Sitzung (Session-Cookies) oder dauerhaft (permanente Cookies) auf Ihrem Endger&auml;t
                ...
                <p>Cookies haben verschiedene Funktionen. Zahlreiche Cookies sind technisch notwendig, da bestimmte
                    ...
                    oder die Anzeige von Videos). Andere Cookies k&ouml;nnen zur Auswertung des Nutzerverhaltens oder zu
                ...
                <p>Cookies, die zur Durchf&uuml;hrung des elektronischen Kommunikationsvorgangs, zur Bereitstellung
                    ...
                    zur Optimierung der Website (z.&nbsp;B. Cookies zur Messung des Webpublikums) erforderlich sind
                ...
                <h3 class="text-xl font-extrabold dark:text-white my-1">Server-Log-Dateien</h3>
                ...
                <h3 class="text-xl font-extrabold dark:text-white my-1">Kontaktformular</h3>
                ...
                <p>Die von Ihnen im Kontaktformular eingegebenen Daten verbleiben bei uns, bis Sie uns zur L&ouml;schung
                    ...
                    Zwingende gesetzliche Bestimmungen &ndash; insbesondere Aufbewahrungsfristen &ndash; bleiben unber&uuml;hrt.</p>
                <h2 class="text-3xl font-extrabold dark:text-white my-1">5. Soziale Medien</h2>
                <h3 class="text-xl font-extrabold dark:text-white my-1">Instagram</h3>
                <p>Auf dieser Website sind Funktionen des Dienstes Instagram eingebunden. Diese Funktionen werden
                    ...
                    Dublin 2, Irland.</p>
                <p>Wenn das Social-Media-Element aktiv ist, wird eine direkte Verbindung zwischen Ihrem Endger&auml;t
                    und dem Instagram-Server hergestellt. Instagram erh&auml;lt dadurch Informationen &uuml;ber den
                    Besuch dieser Website durch Sie.</p>
                <p>Wenn Sie in Ihrem Instagram-Account eingeloggt sind, k&ouml;nnen Sie durch Anklicken des
                    Instagram-Buttons die Inhalte dieser Website mit Ihrem Instagram-Profil verlinken. Dadurch kann
                    Instagram den Besuch dieser Website Ihrem Benutzerkonto zuordnen. Wir weisen darauf hin, dass wir
                    als Anbieter der Seiten keine Kenntnis vom Inhalt der &uuml;bermittelten Daten sowie deren Nutzung
                    durch Instagram erhalten.</p>
                <p>Soweit eine Einwilligung (Consent) eingeholt wurde, erfolgt der Einsatz des o.&nbsp;g. Dienstes auf
                    Grundlage von Art. 6 Abs. 1 lit. a DSGVO und &sect; 25 TTDSG. Die Einwilligung ist jederzeit
                    widerrufbar. Soweit keine Einwilligung eingeholt wurde, erfolgt die Verwendung des Dienstes auf
                    Grundlage unseres berechtigten Interesses an einer m&ouml;glichst umfassenden Sichtbarkeit in den
                    Sozialen Medien.</p>
                <p>Soweit mit Hilfe des hier beschriebenen Tools personenbezogene Daten auf unserer Website erfasst und
                    an Facebook bzw. Instagram weitergeleitet werden, sind wir und die Meta Platforms Ireland Limited, 4
                    Grand Canal Square, Grand Canal Harbour, Dublin 2, Irland gemeinsam f&uuml;r diese Datenverarbeitung
                    verantwortlich (Art. 26 DSGVO). Die gemeinsame Verantwortlichkeit beschr&auml;nkt sich dabei
                    ausschlie&szlig;lich auf die Erfassung der Daten und deren Weitergabe an Facebook bzw. Instagram.
                    Die nach der Weiterleitung erfolgende Verarbeitung durch Facebook bzw. Instagram ist nicht Teil der
                    gemeinsamen Verantwortung. Die uns gemeinsam obliegenden Verpflichtungen wurden in einer
                    Vereinbarung &uuml;ber gemeinsame Verarbeitung festgehalten. Den Wortlaut der Vereinbarung finden
                    Sie unter:
                    ...
                    Laut dieser Vereinbarung sind wir f&uuml;r die Erteilung der Datenschutzinformationen beim Einsatz
                    des Facebook- bzw. Instagram-Tools und f&uuml;r die datenschutzrechtlich sichere Implementierung des
                    Tools auf unserer Website verantwortlich. F&uuml;r die Datensicherheit der Facebook bzw.
                    Instagram-Produkte ist Facebook verantwortlich. Betroffenenrechte (z.&nbsp;B. Auskunftsersuchen)
                    hinsichtlich der bei Facebook bzw. Instagram verarbeiteten Daten k&ouml;nnen Sie direkt bei Facebook
                ...
                <p>Das Unternehmen verf&uuml;gt &uuml;ber eine Zertifizierung nach dem &bdquo;EU-US Data Privacy
                    Framework&ldquo; (DPF). Der DPF ist ein &Uuml;bereinkommen zwischen der Europ&auml;ischen Union und
                    den USA, der die Einhaltung europ&auml;ischer Datenschutzstandards bei Datenverarbeitungen in den
                    USA gew&auml;hrleisten soll. Jedes nach dem DPF zertifizierte Unternehmen verpflichtet sich, diese
                    Datenschutzstandards einzuhalten. Weitere Informationen hierzu erhalten Sie vom Anbieter unter
                    folgendem Link:
                    <a href="https://www.dataprivacyframework.gov/s/participant-search/participant-detail?contact=true&id=a2zt0000000GnywAAC&status=Active" target="_blank" rel="noopener noreferrer">https://www.dataprivacyframework.gov/s/participant-search/participant-detail?contact=true&id=a2zt0000000GnywAAC&status=Active</a>
                </p>
                <h2 class="text-3xl font-extrabold dark:text-white my-1">6. Plugins und Tools</h2>
                <h3 class="text-xl font-extrabold dark:text-white my-1">Google Fonts</h3>
                <p>Diese Seite nutzt zur einheitlichen Darstellung von Schriftarten so genannte Google Fonts, die von
                    Google bereitgestellt werden. Beim Aufruf einer Seite l&auml;dt Ihr Browser die ben&ouml;tigten
                    Fonts in ihren Browsercache, um Texte und Schriftarten korrekt anzuzeigen.</p>
                <p>Zu diesem Zweck muss der von Ihnen verwendete Browser Verbindung zu den Servern von Google aufnehmen.
                    ...
                    Schriftbildes auf seiner Website. Sofern eine entsprechende Einwilligung abgefragt wurde, erfolgt
                    die Verarbeitung ausschlie&szlig;lich auf Grundlage von Art. 6 Abs. 1 lit. a DSGVO und &sect; 25
                    Abs. 1 TTDSG, soweit die Einwilligung die Speicherung von Cookies oder den Zugriff auf Informationen
                    im Endger&auml;t des Nutzers (z.&nbsp;B. Device-Fingerprinting) im Sinne des TTDSG umfasst. Die
                    Einwilligung ist jederzeit widerrufbar.</p>
                ...
                <h3 class="text-xl font-extrabold dark:text-white my-1">Google Maps</h3>
                ...
                <p>Zur Nutzung der Funktionen von Google Maps ist es notwendig, Ihre IP-Adresse zu speichern. Diese
                    ...
                    Google Fonts verwenden. Beim Aufruf von Google Maps l&auml;dt Ihr Browser die ben&ouml;tigten Web
                    Fonts in ihren Browsercache, um Texte und Schriftarten korrekt anzuzeigen.</p>
                <p>Die Nutzung von Google Maps erfolgt im Interesse einer ansprechenden Darstellung unserer
                    ...
                    entsprechende Einwilligung abgefragt wurde, erfolgt die Verarbeitung ausschlie&szlig;lich auf
