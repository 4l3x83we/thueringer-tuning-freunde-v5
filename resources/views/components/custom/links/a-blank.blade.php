@php
    $color = [
        ...
        'red-2' => 'text-red-500 dark:text-red-500 hover:text-red-500/60 hover:dark:text-red-500/60',
        ...
        'blue' => 'text-blue-700 dark:text-blue-600 hover:text-blue-700/60 hover:dark:text-blue-600/60',
...
<a target="{{ $target ?? '_self' }}" href="{{ $href ?? '#' }}" {{ $attributes->merge(['class' => 'inline-flex items-center font-medium duration-300 shadow-xl '. $color]) }}>
    {{ $slot }}
</a>
