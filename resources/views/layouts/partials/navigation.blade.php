...
<section class="bg-gray-200 border-b border-gray-300 dark:border-gray-600 dark:bg-gray-900 hidden xl:block">
    <div class="flex flex-wrap justify-between items-center mx-auto py-2 px-4">
        ...
        <div class="flex items-center">
            <a href="{{ env('TTF_INSTAGRAM') }}" class="mr-4" target="_blank" aria-label="Instagram">
            ...
            <a href="{{ env('TTF_FACEBOOK') }}" class="mr-4" target="_blank" aria-label="facebook">
        ...
        <div x-data="{showMenu : false}" class="flex flex-wrap items-center justify-between mx-auto">
            ...
            <div class="flex items-center xl:order-2 px-4">
                <div class="hidden md:block">
                    <button id="theme-toggle" data-tooltip-target="tooltip-toggle" type="button" class="text-gray-500 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5" aria-label="dark/light mode">
