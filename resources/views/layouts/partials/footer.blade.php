        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-8 px-4 py-6 lg:py-8 lg:grid-cols-4">
            <div>
                ...
                <div class="flex items-center gap-4">
                    <a href="{{ route('intern.pdf.geburtstagsliste') }}" class="bg-primary-500 hover:bg-primary-700 p-2 rounded hover:scale-110 duration-300" target="_blank">
                    ...
                    <a href="{{ route('intern.pdf.telefonliste') }}" class="bg-primary-500 hover:bg-primary-700 p-2 rounded hover:scale-110 duration-300" target="_blank">
                    ...
                    <a href="{{ route('intern.pdf.satzung') }}" class="bg-primary-500 hover:bg-primary-700 p-2 rounded hover:scale-110 duration-300" target="_blank">
